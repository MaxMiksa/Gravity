...
import { PROVIDER_LABELS } from '@gravity/shared'
import type { Channel } from '@gravity/shared'
import { getChannelLogo, GravityLogo } from '@/lib/model-logo'
...
function GravityProviderCard(): React.ReactElement {
  const handleDownload = (): void => {
    window.open('http://gravity.cool/download', '_blank')
  }

  return (
    <SettingsRow
      label="Gravity"
      icon={<img src={GravityLogo} alt="Gravity" className="w-8 h-8 rounded" />}
      description="Gravity 官方供应｜稳定｜靠谱｜丝滑｜简单｜优惠套餐"
    >
